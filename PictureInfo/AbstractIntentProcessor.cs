...
namespace PictureInfo
{
    public abstract class AbstractIntentProcessor : IIntentProcessor
    {
        ...
        protected LexResponse PictureChosen(IDictionary<string, string> sessionAttributes, string fulfillmentState, LexResponse.LexMessage message, LexResponse.LexResponseCard responseCard)
        {
